...
INSERT INTO cities (city_name, state_code, population) VALUES
    ('New York City', 'ny', 19768458),
    ('Los Angeles', 'ca', 17650458),
    ('Chicago', 'il', 9509934),
    ('Dallas', 'tx', 7759615),
    ('Houston', 'tx', 7206841),
    ('San Francisco', 'ca', 6575449),
    ('Washington DC', 'dc', 6356434),
    ('Philadelphia', 'pa', 6228601),
    ('Atlanta', 'ga', 6144050),
    ('Miami', 'fl', 6091747),
    ('Phoenix', 'az', 4946145),
    ('Boston', 'ma', 4899932);
